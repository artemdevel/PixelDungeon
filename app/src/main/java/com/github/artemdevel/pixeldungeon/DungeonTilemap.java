...
import com.github.artemdevel.pixeldungeon.game.common.Tilemap;
...
public class DungeonTilemap extends Tilemap {
    ...
    public static PointF tileCenterToWorld(int pos) {
        return new PointF((pos % Level.WIDTH + 0.5f) * SIZE, (pos / Level.WIDTH + 0.5f) * SIZE);
    }
    ...
    public int screenToTile(int x, int y) {
        Point p = getCamera().screenToCamera(x, y).
