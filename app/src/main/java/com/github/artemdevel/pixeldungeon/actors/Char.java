 ...
 */
package com.github.artemdevel.pixeldungeon.actors;
...
import com.github.artemdevel.pixeldungeon.actors.buffs.Speed;
import com.github.artemdevel.pixeldungeon.actors.buffs.Levitation;
...
import com.github.artemdevel.pixeldungeon.effects.particles.PoisonParticle;
...
import com.github.artemdevel.pixeldungeon.game.utils.GameMath;
...
public abstract class Char extends Actor {
    ...
    public void restoreFromBundle(Bundle bundle) {
        ...
        for (BundleAble b : bundle.getCollection(BUFFS)) {
            if (b != null) {
