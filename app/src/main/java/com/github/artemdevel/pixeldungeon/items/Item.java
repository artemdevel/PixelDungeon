...
import com.github.artemdevel.pixeldungeon.effects.Degradation;
...
import com.github.artemdevel.pixeldungeon.sprites.MissileSprite;
...
public class Item implements BundleAble {
    ...
    public boolean doPickUp(Hero hero) {
        if (collect(hero.belongings.backpack)) {
            ...
            Game.sound.play(Assets.SND_ITEM);
...
//            }
            if (isBroken()) {
                ...
                if (levelKnown) {
                    ...
                    Game.sound.play(Assets.SND_DEGRADE);
                }
            }
        }
    }
...
//        return durability <= 0;
    ...
    public void cast(final Hero user, int dst) {
        ...
        Game.sound.play(Assets.SND_MISS, 0.6f, 0.6f, 1.5f);
