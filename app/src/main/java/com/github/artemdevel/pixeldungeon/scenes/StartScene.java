...
import com.github.artemdevel.pixeldungeon.windows.WndChallenges;
import com.github.artemdevel.pixeldungeon.windows.WndClass;
...
public class StartScene extends PixelScene {
    ...
    private class ClassShield extends Button {
        ...
        protected void onTouchDown() {
            ...
            Game.sound.play(Assets.SND_CLICK, 1, 1, 1.2f);
            updateClass(cl);
        }
