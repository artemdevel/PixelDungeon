...
import com.github.artemdevel.pixeldungeon.effects.particles.BlastParticle;
import com.github.artemdevel.pixeldungeon.effects.particles.SmokeParticle;
                    ...
                    if (ch != null) {
                        ...
                        if (dmg > 0) {
                            ...
                            if (ch.isAlive()) {
                                ...
                                GLog.logNegative("You killed yourself with a bomb...");
                            }
                        }
                    }
                }
