...
import com.github.artemdevel.pixeldungeon.actors.mobs.Acidic;
import com.github.artemdevel.pixeldungeon.actors.mobs.Albino;
import com.github.artemdevel.pixeldungeon.actors.mobs.Bandit;
import com.github.artemdevel.pixeldungeon.actors.mobs.Mob;
import com.github.artemdevel.pixeldungeon.actors.mobs.Senior;
import com.github.artemdevel.pixeldungeon.actors.mobs.Shielded;
...
public class Badges {
    ...
    private static HashSet<Badge> restore(Bundle bundle) {
        ...
        for (String name : bundle.getStringArray(BADGES)) {
            // TODO: Should an Exception be caught here as in the old code?
