 ...
 */
package com.github.artemdevel.pixeldungeon.items.weapon;
...
import com.github.artemdevel.pixeldungeon.items.weapon.enchantments.*;
...
abstract public class Weapon extends KindOfWeapon {
    ...
    // TODO: Change imbue to something else
    public enum Imbue {
        NONE,
        SPEED,
        ACCURACY
    ...
    public void process(Char attacker, Char defender, int damage) {
        if (enchantment != null) {
            enchantment.process(this, attacker, defender, damage);
        }
    ...
    public float speedFactor(Hero hero) {
        ...
        return (encumbrance > 0 ? (float) (DLY * Math.pow(1.2, encumbrance)) : DLY) * (imbue == Imbue.SPEED ? 0.6f : 1.0f);
    }
    ...
    public static abstract class Enchantment implements BundleAble {
        ...
        public abstract boolean process(Weapon weapon, Char attacker, Char defender, int damage);
