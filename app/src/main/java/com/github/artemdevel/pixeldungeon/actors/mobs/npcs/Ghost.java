...
import com.github.artemdevel.pixeldungeon.actors.mobs.CursePersonification;
import com.github.artemdevel.pixeldungeon.actors.mobs.FetidRat;
...
import com.github.artemdevel.pixeldungeon.items.armor.ClothArmor;
import com.github.artemdevel.pixeldungeon.items.quest.DriedRose;
import com.github.artemdevel.pixeldungeon.items.quest.RatSkull;
...
import com.github.artemdevel.pixeldungeon.levels.SewerLevel;
import com.github.artemdevel.pixeldungeon.scenes.GameScene;
import com.github.artemdevel.pixeldungeon.sprites.GhostSprite;
import com.github.artemdevel.pixeldungeon.utils.Utils;
import com.github.artemdevel.pixeldungeon.windows.WndQuest;
import com.github.artemdevel.pixeldungeon.windows.WndSadGhost;
...
public class Ghost extends NPC {
    ...
    public void interact() {
        ...
        Game.sound.play(Assets.SND_GHOST);
    ...
    private static final QuestHandler roseQuest = new QuestHandler() {
        private static final String TXT_ROSE1 = "Hello adventurer... Once I was like you - strong and confident... " +
        ...
        private static final String TXT_ROSE2 = "Please... Help me... _Find the rose_...";

        private static final String TXT_ROSE3 = "Yes! Yes!!! This is it! Please give it to me! " +
    ...
    private static final QuestHandler ratQuest = new QuestHandler() {
        private static final String TXT_RAT1 = "Hello adventurer... Once I was like you - strong and confident... " +
            "And now I'm dead... But I can't leave this place... Not until I have my revenge... " +
            "Slay the _fetid rat_, that has taken my life...";

        private static final String TXT_RAT2 = "Please... Help me... _Slay the abomination_...";

        private static final String TXT_RAT3 = "Yes! The ugly creature is slain and I can finally rest... " +
    ...
    private static final QuestHandler curseQuest = new QuestHandler() {
        private static final String TXT_CURSE1 = "Hello adventurer... Once I was like you - strong and confident... " +
            "And now I'm dead... But I can't leave this place, as I am bound by a horrid curse... " +
            "Please... Help me... _Destroy the curse_...";
        private static final String TXT_CURSE2 = "Thank you, %s! The curse is broken and I can finally rest... " +
            "Please take one of these items, maybe they " +
            "will be useful to you in your journey...";
