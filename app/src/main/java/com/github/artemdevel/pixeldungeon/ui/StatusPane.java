...
import com.github.artemdevel.pixeldungeon.effects.particles.BloodParticle;
...
public class StatusPane extends Component {
    ...
    protected void layout() {
        ...
        avatar.x = PixelScene.align(getCamera(), shield.x + 15 - avatar.width / 2);
        avatar.y = PixelScene.align(getCamera(), shield.y + 16 - avatar.height / 2);
