...
import com.github.artemdevel.pixeldungeon.actors.mobs.npcs.Blacksmith;
import com.github.artemdevel.pixeldungeon.actors.mobs.npcs.Imp;
import com.github.artemdevel.pixeldungeon.actors.mobs.npcs.Ghost;
import com.github.artemdevel.pixeldungeon.actors.mobs.npcs.Wandmaker;
...
import com.github.artemdevel.pixeldungeon.items.rings.Ring;
import com.github.artemdevel.pixeldungeon.items.scrolls.Scroll;
import com.github.artemdevel.pixeldungeon.items.wands.Wand;
import com.github.artemdevel.pixeldungeon.levels.CavesBossLevel;
import com.github.artemdevel.pixeldungeon.levels.CavesLevel;
import com.github.artemdevel.pixeldungeon.levels.CityBossLevel;
import com.github.artemdevel.pixeldungeon.levels.CityLevel;
import com.github.artemdevel.pixeldungeon.levels.DeadEndLevel;
import com.github.artemdevel.pixeldungeon.levels.HallsBossLevel;
import com.github.artemdevel.pixeldungeon.levels.HallsLevel;
import com.github.artemdevel.pixeldungeon.levels.LastLevel;
import com.github.artemdevel.pixeldungeon.levels.LastShopLevel;
import com.github.artemdevel.pixeldungeon.levels.Level;
import com.github.artemdevel.pixeldungeon.levels.PrisonBossLevel;
import com.github.artemdevel.pixeldungeon.levels.PrisonLevel;
import com.github.artemdevel.pixeldungeon.levels.Room;
import com.github.artemdevel.pixeldungeon.levels.SewerBossLevel;
import com.github.artemdevel.pixeldungeon.levels.SewerLevel;
import com.github.artemdevel.pixeldungeon.scenes.GameScene;
import com.github.artemdevel.pixeldungeon.scenes.StartScene;
...
import com.github.artemdevel.pixeldungeon.game.utils.SparseArray;
...
public class Dungeon {
    ...
    public static void switchLevel(final Level level, int pos) {
        nightMode = Calendar.getInstance().get(Calendar.HOUR_OF_DAY) < 7;
    ...
    public static void loadGame(String fileName, boolean fullLoad) throws IOException {
        ...
        for (int i = 2; i <= Statistics.deepestFloor + 1; i++) {
            ...
            for (BundleAble b : bundle.getCollection(String.format(DROPPED, i))) {
                dropped.add((Item) b);
            }
            if (!dropped.isEmpty()) {
